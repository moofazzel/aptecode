...
/** ---- Timing control (mirrors your other sections) ---- */
...
export default function MissionVision() {
  return (
    <section className="about-company-section relative overflow-hidden">
      <div className="mx-auto max-w-[1405px] px-4 py-[50px] md:py-28">
        {/* FLEX LAYOUT */}
        <div className="md:flex flex-col gap-12 lg:flex-row lg:items-center">
          ...
          <div className="about-copy md:w-[50%] w-full">
            ...
            {/* Tabs (shadcn) */}
            <MotionCard delay={BASE + STEP * 2} direction="right">
              <Tabs defaultValue="mission" className="mt-6">
                ...
                {/* Tab contents are wrapped in MotionCard so the content slides in too */}
                <TabsContent
                  value="mission"
                ...
                >
                  <MotionCard
                    delay={BASE + STEP * 3}
                    direction="right" /* key to re-trigger if you want on tab switch */
                  >
                ...
                <TabsContent
                  ...
                  className="md:pt-6 mt-[75px] md:mt-0"
                >
                  <MotionCard delay={BASE + STEP * 3} direction="right">
                    <h3 className="text-[24px] font-[700] mb-[30px] text-[#11151c]">
                      Digital Web Design Agency
                    </h3>
                    <p className="mb-[20px] text-[#74787C] text-[16px]">
