    ...
    <section className="py-20 lg:py-32 ">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="lg:col-span-4">
            <motion.div className="space-y-8 bg-[#f2f4f5] border border-[#e8eaeb] dark:bg-slate-800 dark:border-slate-600 p-8 lg:p-10" variants={fadeInUp}>
              {/* Section Heading */}
      ...
      bg-clip-text text-transparent  h-[30px] relative z-50"
                ...
                <motion.p 
                  ...
                  variants={fadeInUp}
                >
                  Thank you for your interest in Aptecode. Reach out and let{"'"}s create your next digital success story.
                </motion.p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  <div className="relative">
                    ...
                    >
                      <span className={selectedTopic === 'Select Query Topic' ? 'text-slate-500 dark:text-slate-400' : ''}>
                        {selectedTopic}
                      </span>
                      ...
                      <div className="absolute top-full left-0 right-0 mt-1 bg-white dark:bg-slate-700 border border-slate-300 dark:border-slate-600 shadow-lg z-10">
                        {topicOptions.map((option) => (
                          <button
                            key={option.value}
                            type="button"
                            onClick={() => handleTopicSelect(option.value, option.label)}
