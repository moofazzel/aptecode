  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div
          className="pointer-events-none select-none leading-none text-[#3F5AF324] font-[600] text-[65px] sm:text-[112px] md:text-[130px] lg:text-[138px]  tracking-[3px]"
          itemProp="value"
        >
          <CountUp
            end={value}
      ...
      <div
        className="absolute top-1/2 lg:left-[56%] left-[49%] -translate-y-1/2 translate-x-4 sm:translate-x-6"
        itemProp="name"
      >
      ...
      <meta
        ...
        content={`${statLabel}: ${value}${suffix ?? ""}`}
      />
    </div>
  );
}
