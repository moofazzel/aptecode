  ...
  return (
    <div className="relative h-28 sm:h-32 md:h-36 lg:h-40">
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="pointer-events-none select-none leading-none text-[#3F5AF324] font-[600] text-[65px] sm:text-[112px] md:text-[130px] lg:text-[138px]  tracking-[3px]">
          <CountUp
            end={value}
            duration={2}
            enableScrollSpy
      ...
      <div className="absolute top-1/2 lg:left-[56%] left-[49%] -translate-y-1/2 translate-x-4 sm:translate-x-6">
